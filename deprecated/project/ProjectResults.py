...
class ProjectResults:
    ...
    def load_meta_result(self, file_name: str, *args, **kwargs) -> Any:
        return io.load(self.meta_dir / file_name, *args, **kwargs)

    def dump_meta_result(self, file_name: str, data: Any, *args, **kwargs) -> None:
        io.dump(self.meta_dir / file_name, data, *args, **kwargs)
